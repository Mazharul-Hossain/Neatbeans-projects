...
public class Certificate_004 implements Serializable
{
    ...
    Calendar datetime;
     ...
     public Certificate_004(String auth, String name, String IP, KeyPair p, Calendar c)
     {
          authenticator = auth ;
          cname = name;
          ip = IP;
