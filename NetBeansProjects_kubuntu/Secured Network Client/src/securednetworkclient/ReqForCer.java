...
public class ReqForCer
{
    public KeyPair myKeyPair;

    public ReqForCer(){}
            
    public KeyPair byKeyPair() throws NoSuchAlgorithmException, InvalidAlgorithmParameterException
    {
        DHParameterSpec dhSkipParamSpec;

        dhSkipParamSpec = new DHParameterSpec(skip1024Modulus, skip1024Base);

        System.out.println("Generate DH keypair .........calling: ReqForCer.byKeyPair");
